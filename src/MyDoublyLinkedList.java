...
public class MyDoublyLinkedList<E> extends MyAbstractSequentialList<E> implements Cloneable {
	...
	@Override
	public E getLast() {
		return dummyhead.previous.element;
	}
	...
	public E removeLast() throws NoSuchElementException {
		if (size == 0)
			throw new NoSuchElementException();
		Node<E> node = dummyhead.previous;
		dummyhead.previous = node.previous;
		node.previous.next = dummyhead;
		node.next = null;
		node.previous = null;
		size--;
		return node.element;
	...
	public Object clone() {
		...
		newlist.dummyhead = new Node<E>(null);
		newlist.size = 0;
	...
	private class DoublyLinkedListIterator implements ListIterator<E> {
		private Node<E> current = dummyhead.next, lastNode = null;
		private int index;
		...
		@Override
		public void add(E e) {
			MyDoublyLinkedList.this.add(index, e);
			index++;
			lastNode = null;
		}
	}
